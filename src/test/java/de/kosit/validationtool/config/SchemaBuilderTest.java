...
public class SchemaBuilderTest {
    ...
    public void testBuildNamedSchema() {
        ...
        assertThat(result).isNotNull();
        assertThat(result.isValid()).isTrue();
        assertThat(result.getObject().getKey().getResource().stream().map(ResourceType::getName).findFirst()
                .orElseThrow(() -> new IllegalStateException("Not found"))).isEqualTo("myname");
    }
